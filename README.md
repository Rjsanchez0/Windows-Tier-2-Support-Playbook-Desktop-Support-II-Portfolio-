...
- **T2-003** VPN can't connect (triage): [docs/tickets/T2-003_VPN_Cant_Connect_Triage.md](docs/tickets/T2-003_VPN_Cant_Connect_Triage.md)
- **T2-004** Outlook/M365 sign-in loop: [docs/tickets/T2-004_Outlook_M365_SignIn_Loop.md](docs/tickets/T2-004_Outlook_M365_SignIn_Loop.md)
- **T2-005** No internet (DNS/DHCP): [docs/tickets/T2-005_No_Internet_DNS_DHCP.md](docs/tickets/T2-005_No_Internet_DNS_DHCP.md)
- **T2-006** Windows slow triage: [docs/tickets/T2-006_Windows_Slow_Triage.md](docs/tickets/T2-006_Windows_Slow_Triage.md)
